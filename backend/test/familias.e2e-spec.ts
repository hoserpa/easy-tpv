...
describe('Familias API (e2e)', () => {
  ...
  describe('/familias/:id (GET)', () => {
    it('should return 404 for non-existent familia', () => {
      return request(app.getHttpServer()).get('/familias/999').expect(404);
    });

    it('should return 400 for invalid ID', () => {
      return request(app.getHttpServer()).get('/familias/invalid').expect(400);
    });
  ...
  describe('/familias/:id (DELETE)', () => {
    it('should return 404 for non-existent familia', () => {
      return request(app.getHttpServer()).delete('/familias/999').expect(404);
    });
