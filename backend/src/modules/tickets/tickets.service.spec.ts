...
describe('TicketsService', () => {
  ...
  describe('create', () => {
    it('should create a new ticket with lines', () => {
      ...
      expect(result.ticket.subtotal).toBe(25.00)
      expect(result.ticket.total).toBe(25.00)
      ...
      expect(result.lines[1].total).toBe(5.00)
    })
    ...
    it('should calculate line discount correctly - fixed', () => {
      ...
      expect(result.lines[0].total).toBe(15.00)
      expect(result.ticket.total).toBe(15.00)
    })
    ...
    it('should calculate line discount correctly - percent', () => {
      ...
      expect(result.lines[0].total).toBe(18.00)
      expect(result.ticket.total).toBe(18.00)
    })
    ...
    it('should calculate ticket discount correctly - fixed', () => {
      ...
      expect(result.ticket.subtotal).toBe(100.00)
      expect(result.ticket.total).toBe(90.00)
    })
